...
import sys
import os
from pyribbit import __version__
...
latex_documents = [
    (master_doc, "pyribbit.tex", "pyribbit Documentation", "Matthew Matl", "manual"),
]
...
man_pages = [(master_doc, "pyribbit", "pyribbit Documentation", [author], 1)]
...
intersphinx_mapping = {
    ...
    "pyribbit": ("https://pyribbit.readthedocs.io/en/latest/", None),
}
